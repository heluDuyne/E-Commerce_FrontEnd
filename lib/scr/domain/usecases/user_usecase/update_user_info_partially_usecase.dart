...
class UpdateUserInfoPartiallyUsecase extends BaseParamsUsecase<UserInfoEntity, UserRequestModel>{
  final UserRepository userRepository;
  UpdateUserInfoPartiallyUsecase({required this.userRepository});
  @override
  Future<ApiResultModel<UserInfoEntity>> call(UserRequestModel params) {
    return userRepository.updateUserInfoPartially(params);
  }
