...
class GetListCartItemUsecase
    extends BaseParamsUsecase<CartItemPaginationEntity, NoParams> {
  final CartRepository repository;
  GetListCartItemUsecase({required this.repository});
  @override
  Future<ApiResultModel<CartItemPaginationEntity>> call(NoParams _) {
    return repository.getListCartItem();
  }
}
